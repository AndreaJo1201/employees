...
<html>
	<head>
		...
		<title>UPDATE COMMENT FORM</title>
	</head>
	<body>
	<div class="container">
		...
		<form action="<%=request.getContextPath()%>/board/updateCommentAction.jsp" method="post" id="form">
			<table class="table table-striped table-hover">
				...
				<tr>
					...
					<td class="col-sm-11">
						<textarea rows="3" cols="100" name="commentContent"><%=commentContent %></textarea>
					</td>
				</tr>
				<tr>
