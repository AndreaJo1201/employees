...
<%
	...
	System.out.println("DELETE boardNo :"+boardNo); // boardNo check
	System.out.println("DELETE boardTitle :"+board.boardTitle); // boardTitle check
	System.out.println("--------------------------------------------------------------------------");
...
<html>
	...
	<div class="container">
		<div class="mt-4 p-5 bg-danger text-white rounded col-sm">
			<h1>DELETE BOARD FORM</h1>
		</div>
		
		<form action="<%=request.getContextPath()%>/board/deleteBoardAction.jsp" method="post" id="form">
			<table class="table table-striped table-hover">
				...
				<tr>
					...
					<td class="col-sm-11">
						<input type="text" name="boardTitle" value="<%=board.boardTitle %>" maxlength="500" readonly="readonly">
					</td>
				</tr>
				...
				<tr>
					...
					<td class="col-sm-11">
						<textarea rows="5" cols="135" name="boardContent" readonly="readonly"><%=board.boardContent %></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="col-sm-11">
						<input type="text" name="boardWriter" value="<%=board.boardWriter %>" maxlength="50" readonly="readonly">
					</td>
				</tr>
